<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Userlogin.aspx.cs" Inherits="General_Userlogin" %>
...
<body>
    ...
    <section class="vh-100" style="background-color: #508bfc;">
      ...
      <center><asp:Label runat="server" ID="lblError" CssClass="fw-bold" ></asp:Label></center>
                    <asp:Button runat="server" CssClass="btn btn-primary btn-lg btn-block" OnClick="SignIn_Click" Text="Login" />
      
                  <hr class="my-4">
      
                  <a href="userregister.aspx"  class="btn btn-lg btn-block btn-primary fab fa-google me-2" style="background-color: #dd4b39;"> Sign up</a>
