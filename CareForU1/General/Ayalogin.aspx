<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Ayalogin.aspx.cs" Inherits="General_Ayalogin" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>Aya Login | Care ForU</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="login-box">
            ...
            <div class="extra-links">
                <p><a href="../Aya/ChangePassword.aspx">Forgot password?</a></p>
                <p>Don't have an account? <a href="Ayaregister.aspx">Register</a></p>
            </div>
        </div>
        ...
        <script>
            function validateLogin() {
                const user = document.getElementById('txtEmail').value;
