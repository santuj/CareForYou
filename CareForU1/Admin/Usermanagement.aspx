...
<head runat="server">
    <title>User Management | Admin | Care Foru</title>
...
<body>
   ...
   <!-- Sidebar -->
        ...
        <div class="main-content">
            <h2 class="section-title text-center">Manage Users & Patients</h2>
            ...
            <div class="table-responsive">
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                          <asp:Repeater runat="server" ID="rptUserReg">
                            <ItemTemplate>
                                <tr>
                             
                            <td><img src="data:image/png;base64,<%#Convert.ToBase64String((byte[])Eval("ProfilePicture")) %>" width="50" height="50" class="rounded-circle" /></td>                            <td><%#Eval("Name") %></td>
                            <td><%#Eval("Email") %></td>
                            <td><a href='UserCertificateView.aspx?ID=<%#Eval("ID") %>' target="_blank" class="btn btn-sm btn-outline-primary">View</a></td>
