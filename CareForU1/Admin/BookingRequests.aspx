<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookingRequests.aspx.cs" Inherits="Admin_BookingRequests" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Booking Requests | Admin | Care Foru</title>
...
<img src="../Images/Adminpic.jpg" alt="Admin" class="profile-photo" />
            ...
            <a href="BookingRequests.aspx"><i class="bi bi-calendar-check-fill"></i>Booking Requests</a>
        ...
        <div class="main-content">
            <h2 class="section-title text-center">Monitor & Assign Booking Requests</h2>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-success assign-btn"><i class="bi bi-check-circle"></i> Assign</button>
                            </td>
                        </tr>
