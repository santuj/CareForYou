<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserCertificateView.aspx.cs" Inherits="Admin_UserCertificateView" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>View Documents - Care ForU Admin</title>
        ...
        <div class="col-md-6">
            <div class="card shadow-lg rounded-4">
                <div class="card-body text-center">
                    <h5 class="card-title mb-4 text-primary fw-bold">Aya Certificate</h5>
                    
                    <!-- Certificate Thumbnail -->
                    <img src="" id="imgDocument" runat="server" alt="Aya Certificate" 
